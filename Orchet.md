...
### 3.2 Адаптивная регуляризация
    ...
    Была использована комбинация нескольких разных техник. 
        - Dropout с изменяющимся коэфециентом
        - BatchNormс изменяющимся momentum
        - ReLU
    
    Сильный Dropout на первых эпохах позволил избежать запоминания шума
    BachNorm ускорил обучение и сделал модель более стабильной
    ReLU выделила наиболее важные признаки


### Графики с адаптивной моделью
![alt text](./results/regularization_experiments/3_2.png)